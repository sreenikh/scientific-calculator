...
- Memory STO/RCL: SHIFT+AC enters STO mode; press digit 1-9/0 to store current result to slot A-J; recall by typing A-J in expressions via ALPHA+digit; set slots shown as teal letters in status bar
...
579 Vitest tests covering the expression engine, keypad contracts, statistics engine, distributions, and base-N/bitwise/K-map engine.
